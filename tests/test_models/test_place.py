...
class TestPlace(unittest.TestCase):
    ...
    def test_city_id(self):
        ...
        Place.city_id = "San Francisco"
        self.assertEqual(self.place1.city_id, "San Francisco")
        self.assertEqual(self.place1.city_id, self.place2.city_id)
        self.place1.city_id = "San Diego"
        self.assertEqual(self.place1.city_id, "San Diego")
    ...
    def test_user_id(self):
        ...
        Place.user_id = "JohnDoe"
        self.assertEqual(self.place1.user_id, "JohnDoe")
        self.assertEqual(self.place1.user_id, self.place2.user_id)
        self.place1.user_id = "JaneDoe"
        self.assertEqual(self.place1.user_id, "JaneDoe")
    ...
    def test_name(self):
        ...
        Place.name = "John Doe"
        self.assertEqual(self.place1.name, "John Doe")
        self.assertEqual(self.place1.name, self.place2.name)
        self.place1.name = "Jane Doe"
        self.assertEqual(self.place1.name, "Jane Doe")
